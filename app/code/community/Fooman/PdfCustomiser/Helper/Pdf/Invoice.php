...
class Fooman_PdfCustomiser_Helper_Pdf_Invoice extends Fooman_PdfCustomiser_Helper_Pdf
{
    ...
    public function getColumnOrderAndWidth()
    {
        if (!isset($this->_parameters[$this->getStoreId()]['invoicecolumnwidths'])) {
            if (Mage::getStoreConfig('sales_pdf/invoice/invoicecolumnwidths', $this->getStoreId())) {
                $this->_parameters[$this->getStoreId()]['invoicecolumnwidths'] = json_decode(Mage::getStoreConfig('sales_pdf/invoice/invoicecolumnwidths', $this->getStoreId()), true);
            } else {
                $this->_parameters[$this->getStoreId()]['invoicecolumnwidths'] = $this->getDefaultColumnOrderAndWidth();
            }
        }
    ...
    public function getPdfTitle()
    {
        if (!isset($this->_parameters[$this->getStoreId()]['invoicetitle'])) {
            $this->_parameters[$this->getStoreId()]['invoicetitle'] = Mage::getStoreConfig('sales_pdf/invoice/invoicetitle', $this->getStoreId());
        }
    ...
    public function getPdfInvoiceTaxNumber()
    {
        if (!isset($this->_parameters[$this->getStoreId()]['invoicetaxnumber'])) {
            $this->_parameters[$this->getStoreId()]['invoicetaxnumber'] = Mage::getStoreConfig('sales_pdf/invoice/invoicetaxnumber', $this->getStoreId());
        }
    ...
    public function getPdfInvoiceDeliveryDate()
    {
        if (!isset($this->_parameters[$this->getStoreId()]['invoicedeliverydate'])) {
            $this->_parameters[$this->getStoreId()]['invoicedeliverydate'] = Mage::getStoreConfig('sales_pdf/invoice/invoicedeliverydate', $this->getStoreId());
        }
    ...
    public function getPdfAddresses()
    {
        if (!isset($this->_parameters[$this->getStoreId()]['invoiceaddresses'])) {
            $this->_parameters[$this->getStoreId()]['invoiceaddresses'] = Mage::getStoreConfig('sales_pdf/invoice/invoiceaddresses', $this->getStoreId());
        }
    ...
    public function getPdfCustom()
    {
        if (!isset($this->_parameters[$this->getStoreId()]['invoicecustom'])) {
            $this->_parameters[$this->getStoreId()]['invoicecustom'] = Mage::getStoreConfig('sales_pdf/invoice/invoicecustom', $this->getStoreId());
        }
    ...
    public function getPdfIntegratedLabels()
    {
        if (!isset($this->_parameters[$this->getStoreId()]['invoiceintegratedlabels'])) {
            $this->_parameters[$this->getStoreId()]['invoiceintegratedlabels'] = Mage::getStoreConfig('sales_pdf/invoice/invoiceintegratedlabels', $this->getStoreId());
        }
    ...
    public function getTopAdditional()
    {
        ...
        if ($this->getPdfInvoiceDeliveryDate()) {
            $extras .= '<br/>' . Mage::helper('pdfcustomiser')->__('Delivery Date') . ': ' . Mage::helper('core')->formatDate($this->getSalesObject()->getCreatedAtStoreDate(),
                'medium', false);
        }
        return $extras;
    }
    ...
    public function getPdfColumns()
    {
        if (!isset($this->_parameters[$this->getStoreId()]['invoicecolumns'])) {
            $this->_parameters[$this->getStoreId()]['invoicecolumns'] = Mage::getStoreConfig('sales_pdf/invoice/invoicecolumns', $this->getStoreId());
        }
